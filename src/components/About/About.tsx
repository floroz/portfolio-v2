    ...
    <Section id="about">
      <Flexbox>
        ...
        <Text>
          ...
          Vue.js, TypeScript, Next.js, Redux, RxJS, GraphQL, Apollo, Storybook,
          Gatsby, Node, Express, Webpack, Jest, Cypress, Detox, Google
          Analytics, Mixpanel, Optimizely, Datadog, CircleCi.
        </Text>
        <Text>
